...
Current active checkpoint:
  CROWDING / SHARED RANGE / RANGE RELEASE (roadmap item 3) — **ACTIVE AND OPEN. NOT FROZEN.**
  **CORRECTION-35 IS A COMPLETED CANDIDATE AWAITING BROWSER GPT AUDIT.** It closes the ONE blocker
