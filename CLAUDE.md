...
Last updated:
  ...
  NOT PUSHED. Branch checkpoint/dynamic-fission-provisional-successor-38 from WIP review snapshot
  ...
  regressions green, no frozen-evidence churn. The exact local cleanup commit is in the supervisor
