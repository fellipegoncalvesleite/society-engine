...
export const FISSION_FIELD_TRANSFER_POLICY: Record<keyof Band, FieldTransferPolicyEntry> = {
  ...
  practicalAdaptation: entry("DEGRADED_OR_PARTIAL_INHERITANCE", "computed", false, "ITEM-5 — degraded problem framing, fragments, material beliefs and design hints only; parent execution, efficacy, responses, waterworks and local material proof never travel"),
