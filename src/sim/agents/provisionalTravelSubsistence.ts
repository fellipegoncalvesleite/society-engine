...
export const SUBSISTENCE_PHASES: readonly string[] = ["travelling", "establishing", "failed_early", "returning"];
...
/** Exported so a return trigger and an establishment test read the same measured evidence. */
