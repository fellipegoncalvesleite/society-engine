...
const CONTRACTS: readonly PhaseContract[] = [
  {
    ...
    transitionWriter: "naturalFissionPreDeparture (annual proposal adapter)",
  ...
  },
  {
    ...
    productiveLabourOwner: "parent",
    physicalLocationOwner: "parent",
    transitionWriter: "naturalFissionPreDeparture (world adapter)",
  ...
  },
  {
    ...
    productiveLabourOwner: "parent",
    physicalLocationOwner: "parent",
    transitionWriter: "fissionDeparturePreparation (world adapter)",
  ...
  },
  {
    ...
    productiveLabourOwner: "parent",
    physicalLocationOwner: "parent",
    transitionWriter: "naturalFissionPreDeparture / parentFissionAttemptResolver (world adapters)",
    permittedNext: [],
    terminal: true,
