...
- [ ] **Step 1: Create a runtime fixture with contradictory canonical and heuristic evidence**
...
- [ ] **Step 2: Add controlled experiment, response, efficacy, and material-plan cases**
...
- [ ] **Step 3: Add the canonical daughter case through the real inheritor**
...
- [ ] **Step 4: Add the legacy positive control and no-mutation control**
...
- [ ] **Step 5: Add the caller/behavior inventory**
...
- [ ] **Step 6: Run the audit and capture a meaningful RED**
...
- [ ] **Step 7: Commit the RED audit and evidence**
...
- [ ] **Step 1: Add explicit projection authority and canonical metadata types**
...
- [ ] **Step 2: Expose the existing execution classification as a read-only query**
...
- [ ] **Step 3: Implement one pure canonical adapter**
...
- [ ] **Step 4: Route existing public functions canonical-first**
...
- [ ] **Step 5: Extend the adaptation-boundary audit internal allowlist**
...
- [ ] **Step 1: Suppress legacy adaptive profile synthesis for canonical bands**
...
- [ ] **Step 2: Prevent plans from becoming visible-practice diffusion**
...
- [ ] **Step 3: Update Problems & Trials rendering**
...
- [ ] **Step 4: Update Practice Feedback rendering**
...
- [ ] **Step 5: Correct Ideas & Solutions and Technical wording**
...
- [ ] **Step 6: Run the complete focused audit**
...
- [ ] **Step 7: Commit downstream truth consolidation**
...
- [ ] **Step 1: Perform the reversible mutation**
...
- [ ] **Step 2: Run required compile/build and focused audits**
...
- [ ] **Step 3: Run Item-4 freeze audits**
...
- [ ] **Step 4: Run deterministic Map-2 comparison**
...
- [ ] **Step 5: Run and semantically inspect all three benchmarks**
...
- [ ] **Step 1: Write `PASS3_EVIDENCE.md` from measured outputs**
...
- [ ] **Step 2: Update current status documents only**
...
- [ ] **Step 4: Run final fresh verification on the committed tree**
